...
void default_mode()
{
    ...
    int RateMin [] = {70,71,72,73,74, 75, 76, 77, 78, 79, 80, 81,80,79,78,77,76,75,74,73,72,71,70};
	int Period [] = {0,1,1,1,1,2,2,2,0,1,1,1,1,2,2,2,0,1,1,1,1,2,2};
	int Length [] = {0,3,2,1,1,2,2,2,0,3,2,1,1,2,2,2,0,3,2,1,1,2,2};
   ...
   while (true)
   {
	...
	{	
	   ...
	   // clear flash memory if both default mode and reset mode button are on.
