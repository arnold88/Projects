...
function Update () {
	...
	directionVector = pseudoCamera.transform.rotation * directionVector;  //  Camera.main.transform.rotation * directionVector;
	// print(Camera.main.transform.rotation); 
	// Rotate input vector to be perpendicular to character's up vector
	var camToCharacterSpace = Quaternion.FromToRotation(-pseudoCamera.transform.forward, transform.up); //-Camera.main.transform.forward, transform.up
