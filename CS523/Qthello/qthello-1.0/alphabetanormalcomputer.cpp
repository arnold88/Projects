// 
// $Id: alphabetanormalcomputer.cpp,v 1.1.1.1 2000/08/06 10:21:10 amos Exp $
//
// Implementation of AlphaBetaNormalComputer class
//
...
/*!
  \class AlphaBetaNormalComputer alphabetanormalcomputer.hpp
  \brief
...
AlphaBetaNormalComputer::AlphaBetaNormalComputer( QObject *parent, const char *name )
    : ComputerBrain( 6, "Gandalf", parent, name )
{
    for ( int i = 0; i < 8*8; i++ )
        Weights[i] = FB_Weights[i];
}

AlphaBetaNormalComputer::AlphaBetaNormalComputer( const AlphaBetaNormalComputer *b )
    : ComputerBrain( b )
{
    for ( int i = 0; i < 8*8; i++ )
...
AlphaBetaNormalComputer::~AlphaBetaNormalComputer()
{
}

void AlphaBetaNormalComputer::focusIn( Board *b )
{
...
void AlphaBetaNormalComputer::focusOut()
{
    ComputerBrain::focusOut();
}

Brain *AlphaBetaNormalComputer::clone()
{
    return new AlphaBetaNormalComputer( this );
}

QString AlphaBetaNormalComputer::type() const
{
    return "Computer{AlphaBetaNormal}";
}

AlphaBetaNormalComputer::AlphaBetaResult AlphaBetaNormalComputer::preAlphaBeta( int alpha, int beta, Matrix &board )
{
    int level = 0;
...
int AlphaBetaNormalComputer::alphaBeta( int alpha, int beta, int level, int xpos, int ypos, Matrix &board  )
{
...
void AlphaBetaNormalComputer::init()
{
    for ( int i = 0; i < 8*8; i++ )
        Weights[i] = FB_Weights[i];
    Total = 0.0;
