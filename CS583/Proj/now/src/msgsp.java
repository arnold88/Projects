...
public class msgsp {
   ...
   static  DataInputStream DIS = null;
	...
	public static void main(String[] args) {
	    ...
	    String Output = "/Users/entropy/Dropbox/LSRI PhD/3/CS 583/Work/Implementation/output.txt";
    ...
    try{
        ...
        while (DIS.available() != 0)
	    {
     	...
     	// read in MIS value or SDC value
     	  ...
     	  {
     		 int j = line.indexOf('=');
     		 SDC = Double.parseDouble(line.substring(j+1, line.length()));
...
//       }// end test output  --- comment this entire section in real mode
     ...
     {
    	 double temp2 = BigDecimal.valueOf(L.get(x).getCount()).divide(BigDecimal.valueOf(total_cust_count), 25, BigDecimal.ROUND_HALF_UP).doubleValue();
...
//    	   countSequences(dbase, temp_candidate, total_cust_count);
    	 ...
    	 for (Sequence s : temp_candidate)
    		 System.out.println(s.toString() + " : " + s.getCount() + " : " + s.getSup() + " : " + s.getMinsup() + " : " + s.isInSDC(SDC, total_cust_count));
...
//   			 }
//   		 }
    	 temp_f = pruneCandidatesSDC(temp_candidate, dbase, SDC, total_cust_count);
    	 //temp_f = temp_candidate;
    	 
    	 //if (k == 5) break; //TODO REMOVE BEFORE SUBMISSION
  ...
  // either return or output function goes here
    ...
    System.out.println("Results:");
 	...
 	for (int a=0;a<F_one.size();a++)
 	{
 	      ...
 	      System.out.print("Count = " + F_one.get(a).getCount() + "\tSupport = " + F_one.get(a).getSup());
 		  System.out.println("");
 	}
    	 ...
    	 System.out.println("Pattern:");
    	      ...
    	      for (int c=0;c<F_higher.get(b).size(); c++)
    	      {
    	    	  System.out.print(F_higher.get(b).get(c).toString() + "    ");
    	 	      System.out.print("Count = " + F_higher.get(b).get(c).getCount()+ "\tSupport = " + F_higher.get(b).get(c).getSup());
    	 		  System.out.println("");
	 ...
	 */
	public static ArrayList<Sequence> level2CandidateGen(ArrayList<Item> L, ArrayList<Sequence> dbase, double sdc, int n) {
...
//		System.out.println(comp.compare(s_2.getLast(), s_1.getLast()));
	...
	public static ArrayList<Sequence> pruneCandidatesSDC(ArrayList<Sequence> candidates, ArrayList<Sequence> dbase, double sdc, int n) {
		ArrayList<Sequence> prunedCandidates = new ArrayList<Sequence>();
