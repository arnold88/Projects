...
//        double Count = new double(this.getCount());
//       
//        double Trans = new double (n);
      
        //Support = Count.divide(Trans, 8, double.ROUND_FLOOR);
        _support = BigDecimal.valueOf(_count).divide(BigDecimal.valueOf(n), 10, BigDecimal.ROUND_HALF_UP).doubleValue();
