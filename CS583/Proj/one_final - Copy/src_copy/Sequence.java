...
public class Sequence {
	...
	public void setCount(ArrayList<Sequence> dbase, int n) {
	...
	public Sequence removeSecond() {
		if (_sequence.get(0).size() == 1 && _sequence.size() >= 2) // only one Item in the first Itemset and at least 2 Itemsets in Sequence 
			this.removeItem(1, 0);
		else
			this.removeItem(0, 1);
		return this;
