...
PROC IMPORT OUT= WORK.Coil 
            DATAFILE= "E:\IDS462\Homework\HW4\Coil1.xls" 
            DBMS=EXCEL REPLACE;
     SHEET="Sheet1$"; 
     GETNAMES=YES;
     MIXED=NO;
...
*****************************;
*****************************;
****************Monkey around the following lines to test each model;
...
MGODPR2sq=MGODPR2**2;
MGODPR2cu=MGODPR2**3;
MGODPR2inv = 1/MGODPR2;
MGODPR2sqrt = sqrt(MGODPR2);
MGODPR2log = log(MGODPR2);
run;
...
proc logistic data=coil5;
model resp=MGODPR2 MGODPR2sq MGODPR2cu;
run;
