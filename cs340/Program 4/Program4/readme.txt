...
mancala.cpp (mancala class implementation)
mancala.h  (mancala class declaration)
main.cpp  (main program)
ui_mancala.h (user interface object declaration)
mancala.ui (user interface layout)
Program4.Pro (the project file)

Other files may be included to assist Qt to compile the program. All files above should be placed in the same directory.

How to compile:

Open Qt Creator. Open up Program4.Pro.  Hit the green "run" button on the bottom left corner, or hit Ctrl+R key.
